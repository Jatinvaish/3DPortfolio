...
const experiences = [
  ...
  },
  {
    ...
    date: "March 2022 - May 2023",
    points: [
      "Developing and maintaining reusable api with .Net framework.",
      "Collaborating with cross-functional teams including designers, product managers, and other developers to create high-quality products.",
      "Implementing responsive design and ensuring cross-browser compatibility.",
      "Participating in code reviews and providing constructive feedback to other developers.",
    ],
  },
  {
    ...
    date: "March 2022 - May 2023",
    points: [
      "Maintaining Data with Sql server database.",
      "Collaborating with cross-functional teams including designers, product managers, and other developers to create high-quality products.",
      "Implementing responsive design and ensuring cross-browser compatibility.",
      "Participating in code reviews and providing constructive feedback to other developers.",
    ],
  },
  {
    ...
    date: "March 2022 - May 2023",
    points: [
      "Developing and maintaining PWA app with React JS , .Net(Swagger Api) With Sql Server Database.",
      "Collaborating with cross-functional teams including designers, product managers, and other developers to create high-quality products.",
      "Implementing responsive design and ensuring cross-browser compatibility.",
      "Participating in code reviews and providing constructive feedback to other developers.",
    ],
...
const projects = [
  {
    name: "Portfolio",
    description:
      "I create a simple portfolio with sanity cms for learning purpose.",
    tags: [
      {
        name: "ReactJs",
